...
public class MedicoDAO {
	...
	public static boolean save(orm.Medico medico) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().saveObject(medico);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Medico medico) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().deleteObject(medico);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Medico medico) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().getSession().refresh(medico);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Medico medico) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().getSession().evict(medico);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
