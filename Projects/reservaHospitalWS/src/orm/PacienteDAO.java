...
public class PacienteDAO {
	...
	public static boolean save(orm.Paciente paciente) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().saveObject(paciente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Paciente paciente) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().deleteObject(paciente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Paciente paciente) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().getSession().refresh(paciente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Paciente paciente) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().getSession().evict(paciente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
