...
public class ReservaDAO {
	...
	public static boolean save(orm.Reserva reserva) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().saveObject(reserva);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Reserva reserva) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().deleteObject(reserva);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Reserva reserva) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().getSession().refresh(reserva);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Reserva reserva) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().getSession().evict(reserva);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
