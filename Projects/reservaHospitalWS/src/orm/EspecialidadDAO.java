...
public class EspecialidadDAO {
	...
	public static boolean save(orm.Especialidad especialidad) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().saveObject(especialidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Especialidad especialidad) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().deleteObject(especialidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Especialidad especialidad) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().getSession().refresh(especialidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Especialidad especialidad) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().getSession().evict(especialidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
