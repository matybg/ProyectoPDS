...
public class BoxDAO {
	...
	public static boolean save(orm.Box box) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().saveObject(box);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Box box) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().deleteObject(box);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Box box) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().getSession().refresh(box);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Box box) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().getSession().evict(box);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
