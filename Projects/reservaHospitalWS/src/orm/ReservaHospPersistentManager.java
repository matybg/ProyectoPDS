...
public class ReservaHospPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "ReservaHosp";
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ReservaHospPersistentManager();
		}
