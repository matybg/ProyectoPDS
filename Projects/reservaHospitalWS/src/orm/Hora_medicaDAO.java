...
public class Hora_medicaDAO {
	...
	public static boolean save(orm.Hora_medica hora_medica) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().saveObject(hora_medica);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Hora_medica hora_medica) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().deleteObject(hora_medica);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Hora_medica hora_medica) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().getSession().refresh(hora_medica);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Hora_medica hora_medica) throws PersistentException {
		try {
			orm.ReservaHospPersistentManager.instance().getSession().evict(hora_medica);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
