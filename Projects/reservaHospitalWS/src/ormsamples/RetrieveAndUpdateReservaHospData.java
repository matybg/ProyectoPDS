...
import org.orm.*;
public class RetrieveAndUpdateReservaHospData {
	...
	public static void main(String[] args) {
		try {
			RetrieveAndUpdateReservaHospData retrieveAndUpdateReservaHospData = new RetrieveAndUpdateReservaHospData();
			try {
				retrieveAndUpdateReservaHospData.retrieveAndUpdateTestData();
				//retrieveAndUpdateReservaHospData.retrieveByCriteria();
			}
			finally {
