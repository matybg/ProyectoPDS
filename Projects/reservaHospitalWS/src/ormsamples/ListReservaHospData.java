...
import org.orm.*;
public class ListReservaHospData {
	...
	public static void main(String[] args) {
		try {
			ListReservaHospData listReservaHospData = new ListReservaHospData();
			try {
				listReservaHospData.listTestData();
				//listReservaHospData.listByCriteria();
			}
			finally {
